...
//	유저가 펀딩한 내역의 수를 불러오기 위함
	@Override
	public int getUserFundingById(UserDTO userid) {
...
//	유저가 기부한 기부프로젝트의 기부명을 불러옴
	@Override
	public List<String> getDonationNameById(UserDTO userid) {
		
		return umapper.getDonationNameById(userid);
	}
//	유저가 참여한 기부 프로젝트의 담당자 이름을 불러옴
	@Override
	public List<String> getDonaUserNameById(UserDTO userid) {
...
//	유저가 기부한 기부 프로젝트의 설립일 불러오기
	@Override
	public List<String> getDoneTimeById(UserDTO userid) {
