...
function replyList(cBoardnum) {
   ...
   console.log("cBoardnum : " +cBoardnum);
   ...
   if (commentlastnum != 0 && commentlastnum != 1) {
      commentlastnum--;
   }
   console.log("commentlastnum:"+ commentlastnum)
   $.ajax({
      ...
      success: function(data) {
         ...
         console.log("data마지막 숫자 : "+data[data.length - 1].comment.commentnum)
